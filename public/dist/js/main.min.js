...
var getBets=function(t){this.url="",this.btn=t,this.pressedBtn=null,this.addListeners()};getBets.prototype={constructor:getBets,addListeners:function(){this.btn.on("click",$.proxy(this.getBets,this))},getBets:function(t){this.pressedBtn=$(t.target);var e=this.pressedBtn.data("market");this.runnerId=e.runner[0].id,this.marketId=e.market_id,this.store()},store:function(){var t=this;$.ajax("/get-bets",{type:"post",data:{marketId:t.marketId},dataType:"json",beforeSend:function(){},success:function(e){var n=t.btn.closest(".panel").find(".panel-body").find("table");if(e[0].runners)for(var r=0;r<e[0].runners.length;++r){var s=e[0].runners[r].ex.availableToLay;if(e[0].runners[r].selectionId==t.runnerId)if(s.length)for(var d=0;d<s.length;++d){var i="<tr><td>"+e[0].runners[r].selectionId+"</td>";i+="<td></td>",i=i+"<td>"+s[d].size+"</td>",i=i+"<td>"+s[d].price+"</td>",i=i+"<td>"+e[0].runners[r].status+"</td></tr>",n.append(i)}else{var i="<tr><td>"+e[0].runners[r].selectionId+"</td>";i+="<td></td>",i+="<td></td>",i+="<td></td>",i=i+"<td>"+e[0].runners[r].status+"</td></tr>",n.append(i)}}t.pressedBtn.prop("disabled",!0)},error:function(t,e,n){console.log(t+" - "+e+" - "+n)},complete:function(){t.pressedBtn.prop("disabled",!1)}})}};
