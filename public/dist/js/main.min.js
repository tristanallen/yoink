...
var getBets=function(t){this.url="",this.btn=t,this.pressedBtn=null,this.addListeners()};getBets.prototype={constructor:getBets,addListeners:function(){this.btn.on("click",$.proxy(this.getBets,this))},getBets:function(t){this.pressedBtn=$(t.target);var e=this.pressedBtn.data("market");this.marketId=e.market_id,this.store()},store:function(){var t=this;$.ajax("/get-bets",{type:"post",data:{marketId:t.marketId},dataType:"json",beforeSend:function(){},success:function(e){console.log(e),t.pressedBtn.prop("disabled",!0)},error:function(t,e,s){console.log(t+" - "+e+" - "+s)},complete:function(){t.pressedBtn.prop("disabled",!1)}})}};
